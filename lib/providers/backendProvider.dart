...
class BackendProvider {
  static Future<Response> getFullSchedule(String scheduleId) async {
    var uri = Uri.https('kronox-app-backend.herokuapp.com', '/schedules/' + scheduleId, {'school': 'hkr'});
  ...
  static Future<Response> getSearchResults(String searchQuery) async {
    var uri =
        Uri.https('kronox-app-backend.herokuapp.com', '/schedules/search/', {'search': searchQuery, 'school': 'hkr'});
